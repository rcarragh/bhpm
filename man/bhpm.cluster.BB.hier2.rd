\name{bhpm.cluster.BB.hier2}
\alias{bhpm.cluster.BB.hier2}
%- Also NEED an '\alias' for EACH other topic documented here.
\title{A Two-Level Hierarchical Model for grouped data and clusters with Point-Mass.}
\description{
