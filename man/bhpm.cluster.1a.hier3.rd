\name{bhpm.cluster.1a.hier3}
\alias{bhpm.cluster.1a.hier3}
%- Also NEED an '\alias' for EACH other topic documented here.
\title{A Three-Level Hierarchical Model for Grouped Data with Clusters and without Point-Mass.}
\description{
