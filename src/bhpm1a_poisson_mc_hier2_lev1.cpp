...
// So there is no way of identifying body-system index 3 in clusters 1 as being the same or
...
bhpm1a_poisson_mc_hier2_lev1::bhpm1a_poisson_mc_hier2_lev1()
{
	//Rprintf("bhpm1a_poisson_mc_hier2_lev1::bhpm1a_poisson_mc_hier2_lev1: Default constructor\n");
	mu_theta = NULL;
	mu_gamma = NULL;
	sigma2_theta = NULL;
	sigma2_gamma = NULL;
...
bhpm1a_poisson_mc_hier2_lev1::bhpm1a_poisson_mc_hier2_lev1(SEXP sChains, SEXP sBurnin, SEXP sIter, SEXP sSim_Type,
					SEXP sMem_Model,
...
void bhpm1a_poisson_mc_hier2_lev1::initL2Samples()
{
	int c = 0, t = 0, l = 0, b = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::clear()
{
	release();
	bhpm1a_poisson_mc_hier2_lev0::release();
}

void bhpm1a_poisson_mc_hier2_lev1::releaseL2Samples()
{
	int c = 0, t = 0, b = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::initL2Variables(SEXP pmu_gamma, SEXP pmu_theta, SEXP psigma2_gamma, SEXP psigma2_theta)
{
	int c = 0, t = 0, b = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::releaseL2Variables()
{
	int c = 0, t = 0;
...
bhpm1a_poisson_mc_hier2_lev1::~bhpm1a_poisson_mc_hier2_lev1()
{
	//Rprintf("bhpm1a_poisson_mc_hier2_lev1::bhpm1a_poisson_mc_hier2_lev1 - destructor\n");
	release();
}

void bhpm1a_poisson_mc_hier2_lev1::gibbs_sampler()
{
...
void bhpm1a_poisson_mc_hier2_lev1::simulate_MH()
{
	int i = 0, t = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::simulate_SLICE()
{
	int i = 0, t = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::sample_mu_gamma(int burnin, int iter)
{
	int c = 0, l = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::sample_mu_theta(int burnin, int iter, int tr) 
{
	int c = 0, l = 0;
	...
	for (c = 0; c < gChains; c++) {
		...
		for (b = 0; b < gNumBodySys[0]; b++) {
			...
			double denom = sigma2_theta[c][tr][b] + ((double)nae)*tau2_theta_0;
...
void bhpm1a_poisson_mc_hier2_lev1::sample_sigma2_gamma(int burnin, int iter)
{
	int c = 0, l = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::sample_sigma2_theta(int burnin, int iter, int tr)
{
	int c = 0, l = 0;
...
double bhpm1a_poisson_mc_hier2_lev1::log_f_gamma(int c, int i, int b, int j, double gamm)
{
...
void bhpm1a_poisson_mc_hier2_lev1::sample_gamma_MH(int burnin, int iter)
{
	int c = 0, l = 0;
...
void bhpm1a_poisson_mc_hier2_lev1::sample_gamma_SLICE(int burnin, int iter)
{
	int c = 0, i = 0;
	int K = 0, J = 0;
...
double bhpm1a_poisson_mc_hier2_lev1::log_f_theta(int c, int i, int b, int j, double theta, int t)
{
...
void bhpm1a_poisson_mc_hier2_lev1::sample_theta_MH(int burnin, int iter, int t)
{
	int c = 0, l = 0;
		...
		for (l = 0; l < gNumClusters; l++) {
			...
			for (b = 0; b < gNumBodySys[0]; b++) {
				for ( j = 0; j < gNAE[l][b]; j++) {
					...
					GetRNGstate();
#endif
					double cand = rnorm(gTheta[c][t][l][b][j], gSigma_MH_theta[t][l][b][j]);
#ifdef INDIVIDUAL_RNG
					PutRNGstate();
#endif
...
void bhpm1a_poisson_mc_hier2_lev1::sample_theta_SLICE(int burnin, int iter, int t)
{
	int c = 0, i = 0;
	int K = 0, J = 0;
...
double bhpm1a_poisson_mc_hier2_lev1::cMIN(double a, double b)
{
	if (a < b) {
		return a;
	}
...
void bhpm1a_poisson_mc_hier2_lev1::release()
{
	releaseL2Variables();
...
SEXP bhpm1a_poisson_mc_hier2_lev1::getL2Samples(double*** &data)
{
...
SEXP bhpm1a_poisson_mc_hier2_lev1::getMuThetaSamples()
{
	SEXP samples = R_NilValue;
...
SEXP bhpm1a_poisson_mc_hier2_lev1::getMuGammaSamples()
{
	SEXP samples = R_NilValue;
...
SEXP bhpm1a_poisson_mc_hier2_lev1::getSigma2ThetaSamples()
{
	SEXP samples = R_NilValue;
...
SEXP bhpm1a_poisson_mc_hier2_lev1::getSigma2GammaSamples()
{
	SEXP samples = R_NilValue;
...
void bhpm1a_poisson_mc_hier2_lev1::getMuThetaSamples(int *c, int *l, int* b, double* mu_theta)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
...
void bhpm1a_poisson_mc_hier2_lev1::getMuGammaSamples(int *c, int *l, int* b, double* mu_gamma)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
...
void bhpm1a_poisson_mc_hier2_lev1::getSigma2ThetaSamples(int *c, int *l, int* b, double* sigma2)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
...
void bhpm1a_poisson_mc_hier2_lev1::getSigma2GammaSamples(int *c, int *l, int* b, double* sigma2)
{
	int C = (*c) - 1;
	int B = (*b) - 1;
