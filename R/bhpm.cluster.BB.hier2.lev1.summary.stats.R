...
Id <- "$Id: bhpm.cluster.BB.hier2.lev1.summary.stats.R,v 1.10 2019/06/02 14:12:13 clb13102 Exp clb13102 $"

bhpm.cluster.BB.hier2.lev1.summary.stats <- function(raw, prob = 0.95)
{
	s_base = bhpm.cluster.1a.hier2.lev1.summary.stats(raw, prob)
...
bhpm.cluster.BB.hier2.lev1.print.summary.stats <- function(summ)
{
	if (is.null(summ)) {
