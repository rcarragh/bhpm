# bhpm.cluster.1a.dep.lev1.convergence.diag
# Model bhpm.BB
# R. Carragher
# Date: 29/06/2018
#
...
Id <- "$Id: bhpm.cluster.1a.hier3.lev1.convergence.R,v 1.9 2019/06/02 14:12:12 clb13102 Exp clb13102 $"

bhpm.cluster.1a.dep.lev1.convergence.diag <- function(raw, debug_diagnostic = FALSE)
{
	if (is.null(raw)) {
		print("NULL raw data")
		return(NULL)
...
bhpm.cluster.1a.dep.lev1.print.convergence.summary <- function(conv) {
